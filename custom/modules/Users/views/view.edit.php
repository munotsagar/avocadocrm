        ...
        ?>
            ...
            <script>
                $(document).ready(function(){
                    ...
                    //alert("Great I am Here God, Thank You ... What ever you gave me, some time does not think i am deserving all this thanks and love you....");

                    $("#flat_rate_commission_c").change(function(){
                        $("#percentage_commission_c").val("");

                        $("#percentage_commission_c option").removeAttr("selected");
                    });

                    $("#percentage_commission_c").change(function(){
                        $("#flat_rate_commission_c").val("");
