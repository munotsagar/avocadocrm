...
//{
	//echo "admin";
      ...
      $var3 = $this->bean->card_number3_c;
		...
		$this->dv->fieldDefs['card_number1_c']['value'] = $var11;
		//$this->ss->assign("card_number1_c", $var11);
		$this->dv->fieldDefs['card_number2_c']['value'] = $var12;
		$this->dv->fieldDefs['card_number3_c']['value'] = $var13;
