...
<input type="hidden" name="{$fields.aos_products_fyn_qr_code_boxes_1_name.id_name}" 
id="{$fields.aos_products_fyn_qr_code_boxes_1_name.id_name}" 
value="{$fields.aos_products_fyn_qr_code_boxes_1aos_products_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.aos_products_fyn_qr_code_boxes_1_name.name}" id="btn_{$fields.aos_products_fyn_qr_code_boxes_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.aos_products_fyn_qr_code_boxes_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"aos_products_fyn_qr_code_boxes_1aos_products_ida","name":"aos_products_fyn_qr_code_boxes_1_name"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.aos_products_fyn_qr_code_boxes_1_name.name}" id="btn_clr_{$fields.aos_products_fyn_qr_code_boxes_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.aos_products_fyn_qr_code_boxes_1_name.name}', '{$fields.aos_products_fyn_qr_code_boxes_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
...
<input type="text" name="{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1_name.name}" size="" value="{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1_name.id_name}" 
id="{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1_name.id_name}" 
value="{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1fyn_qr_code_pallette_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1_name.name}" id="btn_{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"fyn_qr_code_pallette_fyn_qr_code_boxes_1fyn_qr_code_pallette_ida","name":"fyn_qr_code_pallette_fyn_qr_code_boxes_1_name"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1_name.name}" id="btn_clr_{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1_name.name}', '{$fields.fyn_qr_code_pallette_fyn_qr_code_boxes_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
...
{/if}  
<input type='text' name='{$fields.truck_info.name}' 
id='{$fields.truck_info.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{/literal}{literal}
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='fyn_QR_CODE_BOXES' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='fyn_QR_CODE_BOXES' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='fyn_QR_CODE_BOXES' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='fyn_QR_CODE_BOXES' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='fyn_QR_CODE_BOXES' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='fyn_QR_CODE_BOXES' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='fyn_QR_CODE_BOXES' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='fyn_QR_CODE_BOXES' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='fyn_QR_CODE_BOXES' for_js=true}{literal}' );
