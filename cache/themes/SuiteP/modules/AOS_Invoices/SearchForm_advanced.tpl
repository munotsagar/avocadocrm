...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='AOS_Invoices'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='billing_contact_advanced'>{sugar_translate label='LBL_BILLING_CONTACT' module='AOS_Invoices'}</label>
                            </div>
            <div class="form-item">
...
<button type="button" name="btn_{$fields.billing_contact_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.billing_contact_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"billing_contact_id_advanced","name":"billing_contact_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.billing_contact_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.billing_contact_advanced.name}.value = ''; this.form.{$fields.billing_contact_id_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='billing_account_advanced'>{sugar_translate label='LBL_BILLING_ACCOUNT' module='AOS_Invoices'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.billing_account_advanced.name}"  class="sqsEnabled"   id="{$fields.billing_account_advanced.name}" size="" value="{$fields.billing_account_advanced.value}" title='Account Name' autocomplete="off"  >
...
<button type="button" name="btn_{$fields.billing_account_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.billing_account_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"billing_account_id_advanced","name":"billing_account_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.billing_account_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.billing_account_advanced.name}.value = ''; this.form.{$fields.billing_account_id_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='number_advanced'>{sugar_translate label='LBL_INVOICE_NUMBER' module='AOS_Invoices'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.number_advanced.name}' 
    ...
    value='{$value}' title='' tabindex='' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='total_amount_advanced'>{sugar_translate label='LBL_GRAND_TOTAL' module='AOS_Invoices'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='end_range_{$id}' 
    ...
    value='{$smarty.request.end_range_total_amount_advanced }' tabindex=''>    
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='due_date_advanced'>{sugar_translate label='LBL_DUE_DATE' module='AOS_Invoices'}</label>
                            </div>
            <div class="form-item">
                                
{assign var="id" value=$fields.due_date_advanced.name }

{if isset($smarty.request.due_date_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.due_date_advanced_range_choice}
{else}
{assign var="starting_choice" value="="}
{/if}
...
{html_options options=$fields.due_date_advanced.options selected=$starting_choice}
</select>
</div>

<div id="{$id}_range_div" style="{if preg_match('/^\[/', $smarty.request.range_due_date_advanced)  || $starting_choice == 'between'}display:none{else}display:''{/if};">
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_due_date_advanced) && !empty($smarty.request.due_date_advanced)}{$smarty.request.due_date_advanced}{else}{$smarty.request.range_due_date_advanced}{/if}' title=''   size="11" class="dateRangeInput">
...
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
{assign var=date_value value=$fields.due_date_advanced.value }
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_due_date_advanced }' title=''  tabindex='' size="11" class="rangeDateInput">
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.due_date_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_due_date_advanced }' title=''  tabindex='' size="11" class="dateRangeInput" maxlength="10">
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_advanced'>{sugar_translate label='LBL_STATUS' module='AOS_Invoices'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='status_advanced' name='status_advanced[]' options=$fields.status_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.status_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='AOS_Invoices'}</label>
                            </div>
            <div class="form-item">
