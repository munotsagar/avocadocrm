...
{/if}  
<input type='text' name='{$fields.customerid_c.name}' 
id='{$fields.customerid_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{/if}  
<input type='text' name='{$fields.balanceamount_c.name}' 
id='{$fields.balanceamount_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_SPECIAL_SUGGESTION' module='AOS_Quotes'}{/capture}
{$label|strip_semicolon}:
...
{if empty($fields.special_suggestion_c.value)}
{assign var="value" value=$fields.special_suggestion_c.default_value }
{else}
{assign var="value" value=$fields.special_suggestion_c.value }
{/if}
<textarea  id='{$fields.special_suggestion_c.name}' name='{$fields.special_suggestion_c.name}'
rows="4"
cols="20"
title='' tabindex="0" 
 >{$value}</textarea>
...
{/literal}{literal}
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', false,'{/literal}{sugar_translate label='LBL_NAME' module='AOS_Quotes' for_js=true}{literal}' );
...
addToValidate('EditView', 'addr_status_c', 'enum', false,'{/literal}{sugar_translate label='LBL_ADDR_STATUS' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'cancelreason_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CANCELREASON' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'balanceamount_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BALANCEAMOUNT' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'sales_commission_user_c', 'relate', false,'{/literal}{sugar_translate label='LBL_SALES_COMMISSION_USER' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'canceldate_c', 'date', false,'{/literal}{sugar_translate label='LBL_CANCELDATE' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'commission_amount_c', 'int', false,'{/literal}{sugar_translate label='LBL_COMMISSION_AMOUNT' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'do_no_delete_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_DO_NO_DELETE' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'formattedaddress_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FORMATTEDADDRESS' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'customerid_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CUSTOMERID' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'user_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_SALES_COMMISSION_USER_USER_ID' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'special_suggestion_c', 'text', false,'{/literal}{sugar_translate label='LBL_SPECIAL_SUGGESTION' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'refunddate_c', 'date', false,'{/literal}{sugar_translate label='LBL_REFUNDDATE' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'orderid_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ORDERID' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'formatted_address_c', 'text', false,'{/literal}{sugar_translate label='LBL_FORMATTED_ADDRESS' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'company_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_COMPANY_NAME' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'refundreason_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_REFUNDREASON' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'due_dates_c', 'date', false,'{/literal}{sugar_translate label='LBL_DUE_DATES' module='AOS_Quotes' for_js=true}{literal}' );
addToValidate('EditView', 'updated_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_UPDATED' module='AOS_Quotes' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'sales_commission_user_c', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='AOS_Quotes' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_SALES_COMMISSION_USER' module='AOS_Quotes' for_js=true}{literal}', 'user_id_c' );
