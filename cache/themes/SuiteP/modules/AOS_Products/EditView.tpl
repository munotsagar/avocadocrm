...
{/if}  
<input type='text' name='{$fields.product_model_code_c.name}' 
id='{$fields.product_model_code_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
<span class="dateTime">
{assign var=date_value value=$fields.order_update_daily_c.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.order_update_daily_c.name}" id="{$fields.order_update_daily_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
<button type="button" id="{$fields.order_update_daily_c.name}_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.order_update_daily_c.name}",
form : "EditView",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.order_update_daily_c.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
...
addToValidate('EditView', 'order_update_daily_c', 'date', false,'{/literal}{sugar_translate label='LBL_ORDER_UPDATE_DAILY' module='AOS_Products' for_js=true}{literal}' );
addToValidate('EditView', 'balance_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BALANCE' module='AOS_Products' for_js=true}{literal}' );
addToValidate('EditView', 'truck_c', 'enum', false,'{/literal}{sugar_translate label='LBL_TRUCK' module='AOS_Products' for_js=true}{literal}' );
addToValidate('EditView', 'opencartbalancestock_c', 'int', false,'{/literal}{sugar_translate label='LBL_OPENCARTBALANCESTOCK' module='AOS_Products' for_js=true}{literal}' );
addToValidate('EditView', 'stagging_inventory_c', 'int', false,'{/literal}{sugar_translate label='LBL_STAGGING_INVENTORY' module='AOS_Products' for_js=true}{literal}' );
addToValidate('EditView', 'product_model_code_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PRODUCT_MODEL_CODE' module='AOS_Products' for_js=true}{literal}' );
addToValidate('EditView', 'stockin_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_STOCKIN' module='AOS_Products' for_js=true}{literal}' );
addToValidate('EditView', 'stock_in_from_farm_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_STOCK_IN_FROM_FARM' module='AOS_Products' for_js=true}{literal}' );
addToValidate('EditView', 'for_dailyupdateorder_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FOR_DAILYUPDATEORDER' module='AOS_Products' for_js=true}{literal}' );
addToValidate('EditView', 'stockout_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_STOCKOUT' module='AOS_Products' for_js=true}{literal}' );
