...
{else}
<img src="index.php?entryPoint=download&id={$fields.id.value}_{$fields.photo_c.name}{$fields.width.value}&type={$module}" style="max-width: {if !$vardef.width}120{else}200{/if}px;" height="{if !$vardef.height}{else}50{/if}">
{/if}
</span>
{/if}
...
{if !$fields.typeofbusiness_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.typeofbusiness_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.typeofbusiness_c.name}" value="{ $fields.typeofbusiness_c.options }">
{ $fields.typeofbusiness_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.typeofbusiness_c.name}" value="{ $fields.typeofbusiness_c.value }">
{ $fields.typeofbusiness_c.options[$fields.typeofbusiness_c.value]}
{/if}
{/if}
...
{if !$fields.nationality_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.nationality_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.nationality_c.name}" value="{ $fields.nationality_c.options }">
{ $fields.nationality_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.nationality_c.name}" value="{ $fields.nationality_c.value }">
{ $fields.nationality_c.options[$fields.nationality_c.value]}
{/if}
{/if}
...
{if !$fields.maritalstatus_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.maritalstatus_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.maritalstatus_c.name}" value="{ $fields.maritalstatus_c.options }">
{ $fields.maritalstatus_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.maritalstatus_c.name}" value="{ $fields.maritalstatus_c.value }">
{ $fields.maritalstatus_c.options[$fields.maritalstatus_c.value]}
{/if}
{/if}
...
{if !$fields.customerdiscount_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.customerdiscount_c.name}">{$fields.customerdiscount_c.value}</span>
{/if}
...
{if !$fields.customerrating_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.customerrating_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.customerrating_c.name}" value="{ $fields.customerrating_c.options }">
{ $fields.customerrating_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.customerrating_c.name}" value="{ $fields.customerrating_c.value }">
{ $fields.customerrating_c.options[$fields.customerrating_c.value]}
{/if}
{/if}
...
{if !$fields.taxexempted_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.taxexempted_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.taxexempted_c.name}" value="{ $fields.taxexempted_c.options }">
{ $fields.taxexempted_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.taxexempted_c.name}" value="{ $fields.taxexempted_c.value }">
{ $fields.taxexempted_c.options[$fields.taxexempted_c.value]}
{/if}
{/if}
...
{/if} 
<span class="sugar_field" id="{$fields.comment_c.name}">{$fields.comment_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CARD1' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.card1_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.card1_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.card1_c.name}" value="{ $fields.card1_c.options }">
{ $fields.card1_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.card1_c.name}" value="{ $fields.card1_c.value }">
{ $fields.card1_c.options[$fields.card1_c.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_OWNER1' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{/if} 
<span class="sugar_field" id="{$fields.owner1_c.name}">{$fields.owner1_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CARD_NUMBER1' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.card_number1_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.card_number1_c.name}">{$fields.card_number1_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CCID1' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.ccid1_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.ccid1_c.value) <= 0}
{assign var="value" value=$fields.ccid1_c.default_value }
{else}
{assign var="value" value=$fields.ccid1_c.value }
{/if} 
<span class="sugar_field" id="{$fields.ccid1_c.name}">{$fields.ccid1_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MONTH1' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.month1_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.month1_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.month1_c.name}" value="{ $fields.month1_c.options }">
{ $fields.month1_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.month1_c.name}" value="{ $fields.month1_c.value }">
{ $fields.month1_c.options[$fields.month1_c.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_YEAR1' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.year1_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.year1_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.year1_c.name}" value="{ $fields.year1_c.options }">
{ $fields.year1_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.year1_c.name}" value="{ $fields.year1_c.value }">
{ $fields.year1_c.options[$fields.year1_c.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ADD_NOTES1' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.add_notes1_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.add_notes1_c.value) <= 0}
{assign var="value" value=$fields.add_notes1_c.default_value }
{else}
{assign var="value" value=$fields.add_notes1_c.value }
{/if} 
<span class="sugar_field" id="{$fields.add_notes1_c.name}">{$fields.add_notes1_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CARD2' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.card2_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.card2_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.card2_c.name}" value="{ $fields.card2_c.options }">
{ $fields.card2_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.card2_c.name}" value="{ $fields.card2_c.value }">
{ $fields.card2_c.options[$fields.card2_c.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_OWNER2' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{/if} 
<span class="sugar_field" id="{$fields.owner2_c.name}">{$fields.owner2_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CARD_NUMBER2' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.card_number2_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.card_number2_c.value) <= 0}
{assign var="value" value=$fields.card_number2_c.default_value }
{else}
{assign var="value" value=$fields.card_number2_c.value }
{/if} 
<span class="sugar_field" id="{$fields.card_number2_c.name}">{$fields.card_number2_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CCID2' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.ccid2_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.ccid2_c.value) <= 0}
{assign var="value" value=$fields.ccid2_c.default_value }
{else}
{assign var="value" value=$fields.ccid2_c.value }
{/if} 
<span class="sugar_field" id="{$fields.ccid2_c.name}">{$fields.ccid2_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MONTH2' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.month2_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.month2_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.month2_c.name}" value="{ $fields.month2_c.options }">
{ $fields.month2_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.month2_c.name}" value="{ $fields.month2_c.value }">
{ $fields.month2_c.options[$fields.month2_c.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_YEAR2' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.year2_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.year2_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.year2_c.name}" value="{ $fields.year2_c.options }">
{ $fields.year2_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.year2_c.name}" value="{ $fields.year2_c.value }">
{ $fields.year2_c.options[$fields.year2_c.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ADD_NOTES2' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.add_notes2_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.add_notes2_c.value) <= 0}
{assign var="value" value=$fields.add_notes2_c.default_value }
{else}
{assign var="value" value=$fields.add_notes2_c.value }
{/if} 
<span class="sugar_field" id="{$fields.add_notes2_c.name}">{$fields.add_notes2_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CARD3' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.card3_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.card3_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.card3_c.name}" value="{ $fields.card3_c.options }">
{ $fields.card3_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.card3_c.name}" value="{ $fields.card3_c.value }">
{ $fields.card3_c.options[$fields.card3_c.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_OWNER3' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.owner3_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.owner3_c.value) <= 0}
{assign var="value" value=$fields.owner3_c.default_value }
{else}
{assign var="value" value=$fields.owner3_c.value }
{/if} 
<span class="sugar_field" id="{$fields.owner3_c.name}">{$fields.owner3_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CARD_NUMBER3' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.card_number3_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.card_number3_c.value) <= 0}
{assign var="value" value=$fields.card_number3_c.default_value }
{else}
{assign var="value" value=$fields.card_number3_c.value }
{/if} 
<span class="sugar_field" id="{$fields.card_number3_c.name}">{$fields.card_number3_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CCID3' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.ccid3_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.ccid3_c.value) <= 0}
{assign var="value" value=$fields.ccid3_c.default_value }
{else}
{assign var="value" value=$fields.ccid3_c.value }
{/if} 
<span class="sugar_field" id="{$fields.ccid3_c.name}">{$fields.ccid3_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MONTH3' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.month3_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.month3_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.month3_c.name}" value="{ $fields.month3_c.options }">
{ $fields.month3_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.month3_c.name}" value="{ $fields.month3_c.value }">
{ $fields.month3_c.options[$fields.month3_c.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_YEAR3' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.year3_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.year3_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.year3_c.name}" value="{ $fields.year3_c.options }">
{ $fields.year3_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.year3_c.name}" value="{ $fields.year3_c.value }">
{ $fields.year3_c.options[$fields.year3_c.value]}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ADD_NOTES3' module='Accounts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.add_notes3_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.add_notes3_c.value) <= 0}
{assign var="value" value=$fields.add_notes3_c.default_value }
{else}
{assign var="value" value=$fields.add_notes3_c.value }
{/if} 
<span class="sugar_field" id="{$fields.add_notes3_c.name}">{$fields.add_notes3_c.value}</span>
{/if}
