...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_PHOTO' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_TYPEOFBUSINESS' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
<select name="{$fields.typeofbusiness_c.name}" 
id="{$fields.typeofbusiness_c.name}" 
title=''       
>
{if isset($fields.typeofbusiness_c.value) && $fields.typeofbusiness_c.value != ''}
{html_options options=$fields.typeofbusiness_c.options selected=$fields.typeofbusiness_c.value}
{else}
{html_options options=$fields.typeofbusiness_c.options selected=$fields.typeofbusiness_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.typeofbusiness_c.options }
{capture name="field_val"}{$fields.typeofbusiness_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.typeofbusiness_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.typeofbusiness_c.name}" 
id="{$fields.typeofbusiness_c.name}" 
title=''          
>
{if isset($fields.typeofbusiness_c.value) && $fields.typeofbusiness_c.value != ''}
...
<input
id="{$fields.typeofbusiness_c.name}-input"
name="{$fields.typeofbusiness_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.typeofbusiness_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.typeofbusiness_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.typeofbusiness_c.name}-input', '{$fields.typeofbusiness_c.name}');sync_{$fields.typeofbusiness_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	...
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.typeofbusiness_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.typeofbusiness_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.typeofbusiness_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.typeofbusiness_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.typeofbusiness_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.typeofbusiness_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.typeofbusiness_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.nationality_c.name}" 
id="{$fields.nationality_c.name}" 
title=''       
>
{if isset($fields.nationality_c.value) && $fields.nationality_c.value != ''}
{html_options options=$fields.nationality_c.options selected=$fields.nationality_c.value}
{else}
{html_options options=$fields.nationality_c.options selected=$fields.nationality_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.nationality_c.options }
{capture name="field_val"}{$fields.nationality_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.nationality_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.nationality_c.name}" 
id="{$fields.nationality_c.name}" 
title=''          
>
{if isset($fields.nationality_c.value) && $fields.nationality_c.value != ''}
...
<input
id="{$fields.nationality_c.name}-input"
name="{$fields.nationality_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.nationality_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.nationality_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.nationality_c.name}-input', '{$fields.nationality_c.name}');sync_{$fields.nationality_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.nationality_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.nationality_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.nationality_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.nationality_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.nationality_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.nationality_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.nationality_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_MARITALSTATUS' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.maritalstatus_c.name}" 
id="{$fields.maritalstatus_c.name}" 
title=''       
>
{if isset($fields.maritalstatus_c.value) && $fields.maritalstatus_c.value != ''}
{html_options options=$fields.maritalstatus_c.options selected=$fields.maritalstatus_c.value}
{else}
{html_options options=$fields.maritalstatus_c.options selected=$fields.maritalstatus_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.maritalstatus_c.options }
{capture name="field_val"}{$fields.maritalstatus_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.maritalstatus_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.maritalstatus_c.name}" 
id="{$fields.maritalstatus_c.name}" 
title=''          
>
{if isset($fields.maritalstatus_c.value) && $fields.maritalstatus_c.value != ''}
...
<input
id="{$fields.maritalstatus_c.name}-input"
name="{$fields.maritalstatus_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.maritalstatus_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.maritalstatus_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.maritalstatus_c.name}-input', '{$fields.maritalstatus_c.name}');sync_{$fields.maritalstatus_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.maritalstatus_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.maritalstatus_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.maritalstatus_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.maritalstatus_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.maritalstatus_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.maritalstatus_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.maritalstatus_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CUSTOMERDISCOUNT' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.customerdiscount_c.value) <= 0}
{assign var="value" value=$fields.customerdiscount_c.default_value }
{else}
{assign var="value" value=$fields.customerdiscount_c.value }
{/if}  
<input type='text' name='{$fields.customerdiscount_c.name}' 
id='{$fields.customerdiscount_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CUSTOMERRATING' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.customerrating_c.name}" 
id="{$fields.customerrating_c.name}" 
title=''       
>
{if isset($fields.customerrating_c.value) && $fields.customerrating_c.value != ''}
{html_options options=$fields.customerrating_c.options selected=$fields.customerrating_c.value}
{else}
{html_options options=$fields.customerrating_c.options selected=$fields.customerrating_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.customerrating_c.options }
{capture name="field_val"}{$fields.customerrating_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.customerrating_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.customerrating_c.name}" 
id="{$fields.customerrating_c.name}" 
title=''          
>
{if isset($fields.customerrating_c.value) && $fields.customerrating_c.value != ''}
...
<input
id="{$fields.customerrating_c.name}-input"
name="{$fields.customerrating_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.customerrating_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.customerrating_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.customerrating_c.name}-input', '{$fields.customerrating_c.name}');sync_{$fields.customerrating_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.customerrating_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.customerrating_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.customerrating_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.customerrating_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.customerrating_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.customerrating_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.customerrating_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_TAXEXEMPTED' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.taxexempted_c.name}" 
id="{$fields.taxexempted_c.name}" 
title=''       
>
{if isset($fields.taxexempted_c.value) && $fields.taxexempted_c.value != ''}
{html_options options=$fields.taxexempted_c.options selected=$fields.taxexempted_c.value}
{else}
{html_options options=$fields.taxexempted_c.options selected=$fields.taxexempted_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.taxexempted_c.options }
{capture name="field_val"}{$fields.taxexempted_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.taxexempted_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.taxexempted_c.name}" 
id="{$fields.taxexempted_c.name}" 
title=''          
>
{if isset($fields.taxexempted_c.value) && $fields.taxexempted_c.value != ''}
...
<input
id="{$fields.taxexempted_c.name}-input"
name="{$fields.taxexempted_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.taxexempted_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.taxexempted_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.taxexempted_c.name}-input', '{$fields.taxexempted_c.name}');sync_{$fields.taxexempted_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.taxexempted_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.taxexempted_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.taxexempted_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.taxexempted_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.taxexempted_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.taxexempted_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.taxexempted_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_COMMENT' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.comment_c.value) <= 0}
{assign var="value" value=$fields.comment_c.default_value }
{else}
{assign var="value" value=$fields.comment_c.value }
{/if}  
<input type='text' name='{$fields.comment_c.name}' 
id='{$fields.comment_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
addToValidate('EditView', 'addr_status_c', 'enum', false,'{/literal}{sugar_translate label='LBL_ADDR_STATUS_C' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'photo_c', 'image', false,'{/literal}{sugar_translate label='LBL_PHOTO' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'month2_c', 'enum', false,'{/literal}{sugar_translate label='LBL_MONTH2' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'add_notes2_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ADD_NOTES2' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'dateofbirth_c', 'date', false,'{/literal}{sugar_translate label='LBL_DATEOFBIRTH' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'nationality_c', 'enum', false,'{/literal}{sugar_translate label='LBL_NATIONALITY' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'lastorderdate_c', 'date', false,'{/literal}{sugar_translate label='LBL_LASTORDERDATE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'month3_c', 'enum', false,'{/literal}{sugar_translate label='LBL_MONTH3' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'totalordervalue_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TOTALORDERVALUE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'ccid1_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CCID1' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'owner1_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_OWNER1' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'comment_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_COMMENT' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'owner3_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_OWNER3' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'card_number3_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CARD_NUMBER3' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'totalnooforders_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TOTALNOOFORDERS' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'ccid2_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CCID2' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'owner2_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_OWNER2' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'customerrating_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CUSTOMERRATING' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'year1_c', 'enum', false,'{/literal}{sugar_translate label='LBL_YEAR1' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'maritalstatus_c', 'enum', false,'{/literal}{sugar_translate label='LBL_MARITALSTATUS' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'taxexempted_c', 'enum', false,'{/literal}{sugar_translate label='LBL_TAXEXEMPTED' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'gender_c', 'enum', false,'{/literal}{sugar_translate label='LBL_GENDER' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'card_number2_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CARD_NUMBER2' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'card1_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CARD1' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'leadsource_c', 'enum', false,'{/literal}{sugar_translate label='LBL_LEADSOURCE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'ccid3_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CCID3' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'customerdiscount_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CUSTOMERDISCOUNT' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'customer_group_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CUSTOMER_GROUP' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'lastorderamount_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LASTORDERAMOUNT' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'year2_c', 'enum', false,'{/literal}{sugar_translate label='LBL_YEAR2' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'month1_c', 'enum', false,'{/literal}{sugar_translate label='LBL_MONTH1' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'formatted_address_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FORMATTED_ADDRESS_C' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'card3_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CARD3' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'reseller_certificate_c', 'image', false,'{/literal}{sugar_translate label='LBL_RESELLER_CERTIFICATE' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'add_notes3_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ADD_NOTES3' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'typeofbusiness_c', 'enum', false,'{/literal}{sugar_translate label='LBL_TYPEOFBUSINESS' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'add_notes1_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ADD_NOTES1' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'card2_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CARD2' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'mob_num_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_MOB_NUM' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'card_number1_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CARD_NUMBER1' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'year3_c', 'enum', false,'{/literal}{sugar_translate label='LBL_YEAR3' module='Accounts' for_js=true}{literal}' );
