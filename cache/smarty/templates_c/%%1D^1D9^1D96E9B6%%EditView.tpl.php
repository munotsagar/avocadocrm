...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=fyn_QR_CODE_BOXES'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
&module_name=fyn_QR_CODE_BOXES", true, false,  { "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] } ); return false;' type="button" value="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
"><?php endif; ?><?php endif; ?>
</div>
</td>
...
<?php echo smarty_function_sugar_translate(array('label' => 'DEFAULT','module' => 'fyn_QR_CODE_BOXES'), $this);?>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1aos_products_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"aos_products_fyn_qr_code_boxes_1aos_products_ida","name":"aos_products_fyn_qr_code_boxes_1_name"}}'; ?>
, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['id_name']; ?>
...
_<?php echo $this->_tpl_vars['fields']['aos_products_fyn_qr_code_boxes_1_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_FYN_QR_CODE_PALLETTE_FYN_QR_CODE_BOXES_1_FROM_FYN_QR_CODE_PALLETTE_TITLE">

<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FYN_QR_CODE_PALLETTE_FYN_QR_CODE_BOXES_1_FROM_FYN_QR_CODE_PALLETTE_TITLE','module' => 'fyn_QR_CODE_BOXES'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="fyn_qr_code_pallette_fyn_qr_code_boxes_1_name"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<input type="text" name="<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1fyn_qr_code_pallette_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"fyn_qr_code_pallette_fyn_qr_code_boxes_1fyn_qr_code_pallette_ida","name":"fyn_qr_code_pallette_fyn_qr_code_boxes_1_name"}}'; ?>
, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['id_name']; ?>
');"  value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_LABEL'), $this);?>
" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['fyn_qr_code_pallette_fyn_qr_code_boxes_1_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_TRUCK_INFO">

<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TRUCK_INFO','module' => 'fyn_QR_CODE_BOXES'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="varchar" field="truck_info"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['truck_info']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['truck_info']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['truck_info']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['truck_info']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['truck_info']['name']; ?>
' size='30' 
maxlength='255' 
...
<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'fyn_QR_CODE_BOXES'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'fyn_QR_CODE_BOXES','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'fyn_QR_CODE_BOXES','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'fyn_QR_CODE_BOXES','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'fyn_QR_CODE_BOXES','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'fyn_QR_CODE_BOXES','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'fyn_QR_CODE_BOXES','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'fyn_QR_CODE_BOXES','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'fyn_QR_CODE_BOXES','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'fyn_QR_CODE_BOXES','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'no_of_boxes\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NO_OF_BOXES','module' => 'fyn_QR_CODE_BOXES','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'qr_image\', \'image\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_QR_IMAGE','module' => 'fyn_QR_CODE_BOXES','for_js' => true), $this);?>
<?php echo '\' );
