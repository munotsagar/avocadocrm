<?php /* Smarty version 2.6.31, created on 2019-07-09 07:56:10
         compiled from cache/themes/SuiteP/modules/AOS_Invoices/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/AOS_Invoices/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/AOS_Invoices/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/AOS_Invoices/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/AOS_Invoices/SearchForm_advanced.tpl', 232, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/AOS_Invoices/SearchForm_advanced.tpl', 479, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/AOS_Invoices/SearchForm_advanced.tpl', 560, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/AOS_Invoices/SearchForm_advanced.tpl', 295, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'AOS_Invoices'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='billing_contact_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_CONTACT','module' => 'AOS_Invoices'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='billing_account_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ACCOUNT','module' => 'AOS_Invoices'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
" title='Account Name' autocomplete="off"  >
...
"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='number_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_INVOICE_NUMBER','module' => 'AOS_Invoices'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title='' tabindex='' > 
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='total_amount_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_GRAND_TOTAL','module' => 'AOS_Invoices'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' tabindex=''>    
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='due_date_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DUE_DATE','module' => 'AOS_Invoices'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php $this->assign('id', $this->_tpl_vars['fields']['due_date_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['due_date_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['due_date_advanced_range_choice']); ?>
<?php else: ?>
<?php $this->assign('starting_choice', "="); ?>
<?php endif; ?>
...
_range_change(this.value);">
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['due_date_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_due_date_advanced'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_due_date_advanced'] ) && ! empty ( $_REQUEST['due_date_advanced'] )): ?><?php echo $_REQUEST['due_date_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_due_date_advanced']; ?>
...
<div id="<?php echo $this->_tpl_vars['id']; ?>
_between_range_div" style="<?php if ($this->_tpl_vars['starting_choice'] == 'between'): ?>display:'';<?php else: ?>display:none;<?php endif; ?>">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['due_date_advanced']['value']); ?>
<input autocomplete="off" type="text" name="start_range_<?php echo $this->_tpl_vars['id']; ?>
" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['start_range_due_date_advanced']; ?>
...
" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['end_range_due_date_advanced']; ?>
...
").focus();
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'AOS_Invoices'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
<?php echo smarty_function_html_options(array('id' => 'status_advanced','name' => 'status_advanced[]','options' => $this->_tpl_vars['fields']['status_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['status_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'AOS_Invoices'), $this);?>
</label>
                            </div>
            <div class="form-item">
