<?php /* Smarty version 2.6.31, created on 2019-02-14 17:48:15
         compiled from cache/themes/SuiteP/modules/fyn_vlzs/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/fyn_vlzs/DetailView.tpl', 40, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/fyn_vlzs/DetailView.tpl', 49, false),array('function', 'counter', 'cache/themes/SuiteP/modules/fyn_vlzs/DetailView.tpl', 107, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/fyn_vlzs/DetailView.tpl', 187, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/fyn_vlzs/DetailView.tpl', 100, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/fyn_vlzs/DetailView.tpl', 315, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/fyn_vlzs/DetailView.tpl', 315, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/fyn_vlzs/DetailView.tpl', 315, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='fyn_vlzs'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='fyn_vlzs'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='fyn_vlzs'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='fyn_vlzs'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="relate" field="van_c"  >

<?php if (! $this->_tpl_vars['fields']['van_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['fyn_vehicle_id_c']['value'] )): ?>
<?php ob_start(); ?>index.php?module=fyn_Vehicle&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['fyn_vehicle_id_c']['value']; ?>
...
"><?php endif; ?>
<span id="fyn_vehicle_id_c" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['fyn_vehicle_id_c']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['van_c']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['fyn_vehicle_id_c']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'fyn_vlzs'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php $this->assign('value', "12/06/2018"); ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'fyn_vlzs'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
